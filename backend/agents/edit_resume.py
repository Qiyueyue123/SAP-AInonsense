...
def edit_resume(header, content, mode, text_rephrase=""):
    ...
    chat_template = ChatPromptTemplate.from_messages([
        SystemMessage(content=f'''
            You are an expert career coach guiding the user in writing their resume.
            You have two modes:
        ...
        '''),
        HumanMessage(content=f"Use mode {mode}, for section {header}, with content {content}, in a professional tone.")
    ])
