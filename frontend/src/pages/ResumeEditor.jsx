...
function ResumeEditor() {
  ...
  <div className="resume-editor-container">
    ...
    <main className="resume-editor-main">
      ...
      {/* Section panels */}
      <div id="resume-content-area" className="resume-sections">
        {Object.entries(editableContent).map(([sectionKey, text]) => {
          const textareaId = `textarea-${sectionKey}`;
          return (
            <section key={sectionKey} className="panel">
      ...
      {/* Bottom action bar (below all panels) */}
      <div className="editor-actions">
        {!isEditing ? (
          ...
          <>
            <button onClick={toggleEdit} className="btn btn--subtle">
              Cancel
            </button>
